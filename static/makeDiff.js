var makeDiff = function(comp){
    ...
    var append = "<tr><td>";
    append += nw["time"] + "</tr>";
    append += "<tr><td>song name</td><td class='midtitle' colspan='3'>score</td><td colspan='3' class='midtitle'>TP</td></tr>";
    for(var key in nw["score"]){
        ...
        if(nsong[0]["score"]>osong[0]["score"] || nsong[0]["TP"].toFixed(2)>osong[0]["TP"].toFixed(2)){
            if(nsong[0]["TP"]==100){
                append += "<tr><td class='grn'>"+key+" [ESY]"+"</td>"
            }
            else{
                append += "<tr><td>"+key+" [ESY]"+"</td>"
            }

            if(osong[0]["score"]==1000000){
                append += "<td class='grn'>"+osong[0]["score"]+"</td><td>&gt;&gt;</td>";
            }
            else{
                append += "<td>"+osong[0]["score"]+"</td><td>&gt;&gt;</td>";
            }
        ...
        if(nsong[1]["score"]>osong[1]["score"] || nsong[1]["TP"].toFixed(2)>osong[1]["TP"].toFixed(2)){
            ...
            if(osong[1]["score"]==1000000){
                append += "<td class='grn'>"+osong[1]["score"]+"</td><td>&gt;&gt;</td>";
            }
            else{
                append += "<td>"+osong[1]["score"]+"</td><td>&gt;&gt;</td>";
            }
